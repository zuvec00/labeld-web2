...
const Hero = () => {
	...
	return (
		<section
			className="relative overflow-hidden border-b border-border bg-bg px-6 pb-20 pt-28 md:pb-28 md:pt-36"
		>
			...
			<div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[0.88fr_1.12fr]">
				...
				>
					...
					<h1 className="font-heading text-[clamp(2.4rem,6.3vw,5.8rem)] font-semibold uppercase leading-[1.02] tracking-[-0.02em] text-foreground">
					...
					<p className="mt-7 max-w-xl font-body text-base leading-relaxed text-muted-foreground sm:text-lg">
